...
class ActivityModelTest(TestCase):
    def test_create_activity(self):
        activity = Activity.objects.create(user='Test User', type='run', duration=30, date='2026-02-26')
...
class WorkoutModelTest(TestCase):
    def test_create_workout(self):
        workout = Workout.objects.create(user='Test User', suggestion='Push-ups', date='2026-02-26')
        self.assertEqual(workout.suggestion, 'Push-ups')
